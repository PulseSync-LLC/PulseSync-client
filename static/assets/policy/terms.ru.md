...
1. ОБЩИЕ ПОЛОЖЕНИЯ
    ...
    1.1. Настоящее Лицензионное соглашение (далее — «Лицензия») устанавливает условия использования Программного обеспечения для ЭВМ «PulseSync», версии для Windows (далее — «Программное обеспечение») и заключено между любым лицом, использующим Программное обеспечение (далее — «Пользователь»), и Матвиенко Артём Евгеньевич, являющимся правообладателем исключительного права на Программное обеспечение (далее — «Лицензиар»).
...
Матвиенко Артём Евгеньевич 18.05.2026
...
1. ОБЩИЕ ПОЛОЖЕНИЯ
    ...
    1.1. Настоящее Лицензионное соглашение (далее — «Лицензия») устанавливает условия использования Программного обеспечения для ЭВМ «PulseSync-backend», версии для Windows (далее — «Программное обеспечение») и заключено между любым лицом, использующим Программное обеспечение (далее — «Пользователь»), и Матвиенко Артём Евгеньевич, являющимся правообладателем исключительного права на Программное обеспечение (далее — «Лицензиар»).
