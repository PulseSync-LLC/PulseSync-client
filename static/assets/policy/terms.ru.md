...
6. ОГРАНИЧЕНИЕ ОТВЕТСТВЕННОСТИ
    ...
    6.5. Пользователь настоящим уведомлен и соглашается с настоящим лицензионным соглашением с конечным пользователем для «PulseSync-backend» доступным по адресу: https://github.com/PulseSync-LLC/YMusic-DRPC/blob/dev/static/assets/policy/terms.ru.md.
