...
fn prepare_transaction_file_inner(
    ...
    let prepare_result = (|| -> Result<Value> {
        ...
        let mut result = json!({
            ...
            "hostArtifactSha256": plan.host_artifact_sha256,
            "bootstrapperArtifactSha256": plan.bootstrapper_artifact_sha256,
            "componentElectronAbis": plan.component_electron_abis,
            "componentContentSha256s": plan.component_content_sha256s,
            "componentArtifactSha256s": plan.component_artifact_sha256s,
