...
> [!NOTE]
> ### Если вы столкнулись с ошибками в моде или неработающими функциями и пришли сюда из другого мода, пожалуйста, не создавайте тикеты/issue. 
> ### Эти моды используют функции PulseSync без нашего разрешения, поэтому мы не несем ответственности за их работу.
