...
static void ThrowFsError(Napi::Env env, const std::string& prefix) {
...
#ifndef _WIN32
static bool CopyFilePosix(const std::string& src, const std::string& dst, std::string& errMsg) {
...
NODE_API_MODULE(native_file_ops, Init)
