...
export const desktopApi = {
    ...
    system: {
        ...
        openLastMacUpdatePath: () => requireDesktopApi().system.openLastMacUpdatePath(),
        ...
        onMacUpdateReady: (listener: (payload: unknown) => void) => requireDesktopApi().system.onMacUpdateReady(listener),
