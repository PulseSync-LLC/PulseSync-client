...
export const desktopApi = {
    ...
    mods: {
        ...
        prepareUpdate: (request: Parameters<PulseSyncDesktopApi['mods']['prepareUpdate']>[0]) => requireDesktopApi().mods.prepareUpdate(request),
        ...
        onUpdateDownloadStarted: (listener: (payload: unknown) => void) => requireDesktopApi().mods.onUpdateDownloadStarted(listener),
        onUpdateReady: (listener: (payload: unknown) => void) => requireDesktopApi().mods.onUpdateReady(listener),
