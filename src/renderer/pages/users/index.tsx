...
export default function UsersPage() {
  ...
  const letterVariants = {
    ...
    animate: {
      y: [0, -10, 0],
      transition: {
        y: { repeat: Infinity, repeatType: 'loop', duration: 1, ease: 'easeInOut' },
      },
    },
  }
      ...
      <div className={globalStyles.page}>
        <div className={globalStyles.container}>
          <div className={globalStyles.main_container}>
            <div className={styles.searchContainer} style={backgroundStyle}>
                  ...
                  <div className={styles.userNavContainer}>
                    <button
                      className={`${styles.userNavButton} ${
                        isFieldSorted('createdAt') ? styles.activeSort : ''
                      }`}
                    ...
                    <button
                      className={`${styles.userNavButton} ${
                        isFieldSorted('username') ? styles.activeSort : ''
                      }`}
