...
const getMediaUrl = ({
  ...
  if (ext === 'gif') {
    ...
    return type === 'avatar'
      ? preview
      : `linear-gradient(0deg, #2C303F 0%, rgba(55,60,80,0.3) 100%), url(${preview})`
  }
  return type === 'avatar'
...
const UserCardV2: React.FC<UserCardProps> = ({ user, onClick }) => {
  ...
  return (
    <div ref={containerRef} style={{ width: '100%', height: '150px' }}>
      {!showContent ? (
        <div
          className={styles.userCardSkeleton}
          aria-hidden="true"
        ...
        >
          ...
          >
            ...
            <div className={styles.userInfo}>
              <div className={styles.badges}>
                <TooltipButton
                  tooltipText={`Уровень ${
                    (user as UserInterface).levelInfo.currentLevel
                  }`}
                  side="bottom"
                >
                  <LevelBadge
                    level={(user as UserInterface).levelInfo.currentLevel}
                  />
                </TooltipButton>
                {sortedBadges.map(b => (
                  <TooltipButton
                  ...
                  >
                    <div className={styles.badge}>
                      <img
                        src={`static/assets/badges/${b.type}.svg`}
                        alt={b.name}
          ...
          <div className={styles.bottomSection}>
            <div
              ...
              style={{
                color: isInactive(Number(user.lastOnline))
                  ? '#9885A9'
                  : 'var(--statusColorProfile)',
              }}
            >
