...
import { SocketProvider, useSocketContext } from '@app/providers/socket'
...
import { areTracksEqual, checkInternetAccess, compareVersions, normalizeTrack, notifyUserRetries } from '@shared/lib/utils'
...
import type { AppProvidersProps, GetMeData, GetMeVars, PlayerProps } from '@app/AppShell.types'
